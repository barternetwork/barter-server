import { BatchRequestDocument, BatchRequestsOptions, ClientError, RawRequestOptions, RequestDocument, RequestOptions, BatchRequestsExtendedOptions, RawRequestExtendedOptions, RequestExtendedOptions, Variables } from './types';
...
export declare class GraphQLClient {
    ...
    rawRequest<T = any, V = Variables>(options: RawRequestOptions<V>): Promise<{
        data: T;
        extensions?: any;
        headers: Dom.Headers;
        status: number;
...
export declare function rawRequest<T = any, V = Variables>(options: RawRequestExtendedOptions<V>): Promise<{
    data: T;
    extensions?: any;
    headers: Dom.Headers;
    status: number;
...
export declare function request<T = any, V = Variables>(options: RequestExtendedOptions<V>): Promise<T>;
/**
